<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex items-center justify-center mt-8">
                ...
                <img   class="h-12 w-12" src="{{asset('images/logo.png')}}">
            ...
            <nav class="mt-10">
                ...
                @canany('Incident access','Incident add','Incident edit','Incident delete')
                 <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.incidents.index') ? 'active' : '' }}"
